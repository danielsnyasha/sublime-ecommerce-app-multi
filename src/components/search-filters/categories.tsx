  ...
  return (
    <div className="relative w-full">
      ...
      <div
        ...
        style={{ position: "fixed", top: -999, left: -9999 }}
      >
        {data.map((category) => (
          <div key={category.id}>
            <CategoryDropdown
      ...
      <div
        ref={containerRef}
        className="flex gap-x-2 flex-nowrap items-center"
      ...
      >
        ...
        <div ref={viewAllRef}>
          ...
          )} onClick={()=>setIsSidebarOpen(true)}>View All
